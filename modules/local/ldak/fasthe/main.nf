process LDAK_FASTHE {
    ...
    output:
    tuple val(meta), path("${prefix}.fasthe"), emit: fasthe_results
    tuple val(meta), path("${prefix}.fasthe.liab"), emit: fasthe_liability, optional: true
